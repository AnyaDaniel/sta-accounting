  ...
  return (
    <main>
      <section style={{ background: "#3b1517", color: "#f2ede4", position: "relative", overflow: "hidden" }}>
        ...
        >
          <div style={{ padding: "88px 0 92px" }}>
            <div style={{ font: "500 11.5px/1 var(--font-mono), monospace", letterSpacing: ".2em", color: "#a5ce2b", marginBottom: 22 }}>
              SERVICES
            </div>
            <h1
              style={{
                margin: "0 0 26px",
                font: "600 62px/1.04 var(--font-serif), Georgia, serif",
                letterSpacing: "-.02em",
                textWrap: "pretty",
              }}
            >
            ...
            <p style={{ margin: "0 0 34px", maxWidth: 560, font: "400 18px/1.65 var(--font-sans), sans-serif", color: "#ded5c9", textWrap: "pretty" }}>
          ...
          <div style={{ alignSelf: "stretch", margin: "44px 0", position: "relative", minHeight: 430, borderRadius: 3, overflow: "hidden" }}>
            <img
              ...
              style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "60% 50%", display: "block" }}
            />
            <div
              style={{
                position: "absolute",
      ...
      <section style={{ maxWidth: 1200, margin: "0 auto", padding: "76px 28px 20px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "minmax(0,260px) minmax(0,1fr)", gap: 44, alignItems: "start" }}>
          <h2 style={{ margin: 0, font: "600 30px/1.2 var(--font-serif), Georgia, serif", letterSpacing: "-.01em" }}>What we do</h2>
